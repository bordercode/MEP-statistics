...
Este componente nos aporta información sobre el cumplimiento de los supuestos del modelo. Observamos que posiblemente es necesario mejorar la estimación de los  (modelos!) para grupos específicos de paises en continentes como África (claramente, un comportamiento no lineal) dado que los residuales muestran un patrón no consistente con  un modelo lineal.
