...
#Unnest y plot  componentes de interes. 
unnest(models,tidy)
...
models%>%
  ...
  xlab("Esperanza de vida EV")+
  ylab("Mejora anual en EV al inicio del periodo (1950)")+
  scale_size_area()+
  theme_light()+
  scale_colour_viridis_d()
  
```
#### Algunas observaciones finales sobre el patrón observado con la estimación de los modelos:


¿QUé representaría un punto en la esquina superior derecha?

Un país que tenia una elevada esperanza de vida en 1950 y que ha mejorado este indicador  rapidamente desde entonces. 

Qué indica la usencia de puntos en la esquina superior derecha?

De hecho es un buen indicio por que sugiere que los países que tenian menor EV al inicio de hecho son los que han avanzado más en este indicador.


Los paises en los que el modeo no se ajusta bien estan en Africa mayoritariamente.
Esta información sobre la magnitud del coeficiente de determianción $r^2$ es valiosa por que nos alerta sobre el riesgo de hacer inferencia con base en los modelos estimados para grupo de países específico. 
...
Este componente nos aporta información sobre el cumplimeinto de los supuestos del modelo. Observamos que posiblemente es necesario mejorar el modelo (modelos!) dado que los residuales muestran un patrón, notablemente mas aceptuado en continentes como África.
