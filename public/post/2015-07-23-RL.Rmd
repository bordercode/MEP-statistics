...
Las variables utilizadas serán de dos tipos: **numéricas** ó **categoricas**. A su vez estas corresponden con los siguientes tipos de datos identificados en los programas utilizadso en el curso **Rstudio** y **STATA**: *doubles, integers, characters, logicals.* 
...
e) Estime el coeficeinte de correlación entre tasa de diabetes y la variable sobrepeso (imc promedio por estado  segÚn ENSANUT). 
...
Leer  Capítulo 1. [An Introduction to Statistical Learning](https://drive.google.com/file/d/1zaKc1XWvELsUgZrS32QdpHoM4-w0y7Qx/view?usp=sharing)
