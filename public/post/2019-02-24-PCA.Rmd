...
### Ejemplo 4  Nacimientos México 2016
...
El **objetivo** es aplicar el algoritmo  **PCA** para explorar si es posible explicar la variación en los datos apartir de una estructura dcon menores dimensiones. Adicionalmene determinar que variables estan correlacionadas.
...
El 77% de la varianza es explicada por los primeros 3 componentes. Los tres primeros $\lambda\geq1$. (Criterio de Kaiser).
