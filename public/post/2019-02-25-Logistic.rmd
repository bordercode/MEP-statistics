...
Note que la hipótesis nula $H_0: \hat{\beta_1}=0$ lo que implica que
...
Tal como hacemos en cualquier prueba de hipótesis, rechazams la **hipótesis nula** si el $p-value<\alpha$ threshld de contraste, usualmente 0.05.
