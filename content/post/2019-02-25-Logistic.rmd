...
**Note que Odds no son probabilidades.**  Para llegar a estimar la probilidades que  un evento ocurra dado un conjunto de variables explicativas el modelo de regresión logística considera una serie de supuestos adicionales, en especial es importante incorporar la función logit, que veremos enseguida. 
...
Hacemos ahora predicciones de probabilidades con base en los log(odds) estimados. Por ejemplo para un individuo cuyo balance=$\$1,000$
...
(2920.6-1596.5)/1596.5

ll.null <- logistic$null.deviance
ll.fit <- logistic$deviance

## Donde null.dev es el loglikelihood del modelo nulo (modelo solo con el intercepto)

## McFadden's Pseudo R^2 = [ LL(Null) - LL(fit) ] / LL(Null)
(ll.null - ll.fit) / ll.null

## Si el modelo es útil el r^2 es cercano a 1, no es común.
#Valores aprox .40 son comunes en sc.


## Especificación para el estadístico  chi cuadrada
