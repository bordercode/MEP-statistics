...
Maximizar la función de verosimilitud implica determinar aquella  probabilidad $\hat{p}(x_i)$ que es lo más apegada posible al valor observado. 
...
plot(xseq, densities, col="darkgreen",xlab="", ylab="Densidad", type="l",lwd=2, cex=2, main="Función Densidad de Probabilidades PDF Standard Normal", cex.axis=.8)
