...
La gráfica  *Residuals-leverage* permite detectar **oultilers**, puntos con  valores  elevados en la precdicción dado el valor de ${x_i}$.  

Así como valores inusualmente altos de  **x** (*High leverage obs*), relativo al resto de observaciones  datos que pudieran tener una influencia especialmente importante en el modelo. 

La gráfica es  útil para controlar por obsevaciones que pudieran incluso indicar algún problema en la forma en que se capturó la información. 
