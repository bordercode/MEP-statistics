...
Como minimizamos \@ref(eq:rss1)?

Consideramos que **X** como una matriz  **N** x (p+1) con cada renglón como un vector de regresores con el valor 1 en la primer posición y con la variable **y** como el vector **N** de lavariable dependiente. Entonces podemos escribir la suma residual de cuadrados **RSS** como  
