...
Con una matriz ve **varianza-covarianza**$$var(\hat \beta )=(X^TX)^{-1} \sigma^2$$ y el estimado de la varianza estimado como $$\hat \sigma ^2=\frac{1}{N-p-1} \sum_{i=1}^N(y_i -\hat y_i)^2$$
