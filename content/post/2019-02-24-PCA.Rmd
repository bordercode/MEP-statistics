...
summary(pr)
pr
# Hemos obtenido los eigenvalores (Standard deviations^2) y la matrz de eigenvectores eigenvectores (rotation). 

# Calculate variability of each component  (loadings)
pr.var <- pr$sdev ^ 2
round(pr.var, 2)
...
cp1 <- eigenv$vectors[1,1]/eigenv$vectors[2,1]
cp2 <- eigenv$vectors[1,2]/eigenv$vectors[2,2]
